...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeGamejam", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeGamejam", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "HaxeGamejam";
		app.meta["name"] = "HaxeGamejam";
